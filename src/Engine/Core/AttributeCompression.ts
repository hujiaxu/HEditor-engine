...
export default class AttributeCompression {
  ...
  static octEncodeFloat: (vector: Cartesian3, result?: Cartesian2) => number;
   ...
   */
AttributeCompression.octEncodeInRange = (vector: Cartesian3, rangeMax: number, result: Cartesian2 = new Cartesian2()) => {
...
AttributeCompression.octEncode = (vector: Cartesian3, result: Cartesian2 = new Cartesian2()) => {
   ...
   */
AttributeCompression.octEncodeFloat = (vector: Cartesian3, result: Cartesian2 = new Cartesian2()) => {
...
AttributeCompression.octPackFloat = (encoded: Cartesian2) => {
   ...
   */
AttributeCompression.compressTextureCoordinates = (textureCoordinates: Cartesian2) => {
   ...
   * @returns {Cartesian2} The encoded 2D vector.
   */
AttributeCompression.octPack = (v1: Cartesian3, v2: Cartesian3, v3: Cartesian3, result: Cartesian2) => {
