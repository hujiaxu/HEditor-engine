...
interface Check {
  ...
  typeOf: any // or a more specific type if you know it
}
/**
...
const Check: Check = {
  typeOf: undefined,
  defined: function (name: any, test: any): void {
 ...
 */
Check.defined = function (name: string, test: any) {
  if (!defined(test)) {
 ...
 */
Check.typeOf.func = function (name: string, test: any) {
 ...
 */
Check.typeOf.number.lessThan = function (
  name: any,
  test: number,
  limit: number
) {
 ...
 */
Check.typeOf.number.lessThanOrEquals = function (
  name: any,
  test: number,
  limit: number
) {
 ...
 */
Check.typeOf.number.greaterThan = function (
  name: any,
  test: number,
  limit: number
) {
 ...
 */
Check.typeOf.number.greaterThanOrEquals = function (
  name: string,
  test: number,
  limit: number
) {
 ...
 */
Check.typeOf.bool = function (name: string, test: any) {
 ...
 */
Check.typeOf.bigint = function (name: string, test: any) {
 ...
 */
Check.typeOf.number.equals = function (
  name1: string,
  name2: string,
  test1: number,
  test2: number
